...
M_U_bis(:,:,1) = pose(0.7080, -0.1830, 0.8440, 0, 0, 0);
M_U_bis(:,:,2) = pose(0.7080, -0.2670, 0.8440, 0, 0, 0);
M_U_bis(:,:,3) = pose(0.7920, -0.1830, 0.8440, 0, 0, 0);
M_U_bis(:,:,4) = pose(0.7920, -0.2670, 0.8440, 0, 0, 0);
...
% bottle target poses
M_U_bit(:,:,1) = pose(-0.9230, -0.05, 1.6920, 0, 89.98, 0);
M_U_bit(:,:,2) = pose(-0.9230, -0.25, 1.6920, 0, 89.98, 0);
M_U_bit(:,:,3) = pose(-0.9230, -0.45, 1.6920, 0, 89.98, 0);
M_U_bit(:,:,4) = pose(-0.9230, -0.65, 1.6920, 0, 89.98, 0);
% Convert poses w.r.t. robot base {0} and end-effector {6}
for i = 1:1:4
